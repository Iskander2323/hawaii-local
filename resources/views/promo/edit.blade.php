...
<form method="POST" action="{{ url('/admin/promo', $promo->id) }}" accept-charset="UTF-8" enctype="multipart/form-data">
    ...
    <div class="tab-content" id="custom-tabs-two-tabContent">
        ...
        <div class="tab-pane fade active in" id="custom-tabs-two-home" role="tabpanel"
            ...
            <div class="form-group ">
                <label for="name" class="control-label">Наименование RU</label>
                <input class="form-control" name="title[ru]" type="text" id="name" autocomplete="off"
                    value="{{App\Models\Translates::where('id',$promo->title)->value('ru')}}" required>
            </div>
            ...
            <div class="form-group ">
                ...
                <textarea class="form-control" rows="5" name="description[ru]" type="textarea" id="textarea"
                    placeholder="{{App\Models\Translates::where('id', $promo->description)->value('ru')}}">{{App\Models\Translates::where('id', $promo->description)->value('ru')}}</textarea>
            </div>
        ...
        <div class="tab-pane fade" id="custom-tabs-kz" role="tabpanel" aria-labelledby="custom-tabs-two-kz">
            ...
            <div class="form-group ">
                <label for="name" class="control-label">Наименование KZ</label>
                <input class="form-control" name="title[kz]" type="text" id="name" autocomplete="off"
                    value="{{App\Models\Translates::where('id',$promo->title)->value('kz')}}" required>
            </div>
            ...
            <div class="form-group ">
                ...
                <textarea class="form-control" rows="5" name="description[kz]" type="textarea" id="textarea"
                    placeholder="{{App\Models\Translates::where('id', $promo->description)->value('kz')}}">{{App\Models\Translates::where('id', $promo->description)->value('kz')}}</textarea>
            </div>
        </div>
        ...
        <div class="tab-pane fade" id="custom-tabs-two-profile" role="tabpanel"
            ...
            <div class="form-group ">
                <label for="name" class="control-label">Наименование EN</label>
                <input class="form-control" name="title[en]" type="text" id="name" autocomplete="off"
                    value="{{App\Models\Translates::where('id',$promo->title)->value('en')}}" required>
            </div>
            ...
            <div class="form-group ">
                ...
                <textarea class="form-control" rows="5" name="description[en]" type="textarea" id="textarea"
                    placeholder="{{App\Models\Translates::where('id',$promo->description)->value('en')}}">{{App\Models\Translates::where('id', $promo->description)->value('en')}}</textarea>
            </div>
        </div>
    </div>
