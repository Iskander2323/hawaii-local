...
<div class="box box-default">
    <div class="box-body">
        <a href="{{route('promo.index')}}" title="Back"><button class="btn btn-warning btn-sm"><i
                    class="fa fa-arrow-left" aria-hidden="true"></i> Назад</button></a>
        <br />
        <br />
        <form method="POST" action="{{route('promo.store')}}" accept-charset="UTF-8" enctype="multipart/form-data">
            @csrf
            ...
            <div class="tab-content" id="custom-tabs-two-tabContent">
                ...
                <div class="tab-pane fade active in" id="custom-tabs-two-home" role="tabpanel"
                    ...
                    <div class="form-group  ">
                        <label for="title_ru" class="control-label">Название акции RU</label>
                        <input class="form-control" name="title[ru]" type="text" id="ticket_title_ru" value="" required>
                    </div>

                    <div class="form-group  ">
                        <label for="title_ru" class="control-label">Описание акции RU</label>
                ...
                <div class="tab-pane fade" id="custom-tabs-kz" role="tabpanel" aria-labelledby="custom-tabs-two-kz">
                    ...
                    <div class="form-group  ">
                        <label for="title_kz" class="control-label">Название акции KZ</label>
                        <input class="form-control" name="title[kz]" type="text" id="ticket_title_kz" value="" required>
                    </div>

                    <div class="form-group  ">
                        <label for="title_kz" class="control-label">Описание акции KZ</label>
                ...
                <div class="tab-pane fade" id="custom-tabs-two-profile" role="tabpanel"
                    ...
                    <div class="form-group  ">
                        <label for="title_en" class="control-label">Название акции EN</label>
                        <input class="form-control" name="title[en]" type="text" id="ticket_title_en" value="" required>
                    </div>

                    <div class="form-group  ">
                        <label for="title_en" class="control-label">Описание акции EN</label>
