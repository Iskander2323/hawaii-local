...
<form method="POST" action="{{ url('/admin/spainfo', $spainfo->id) }}" accept-charset="UTF-8"
    ...
    <div class="tab-content" id="custom-tabs-two-tabContent">
        ...
        <div class="tab-pane fade active in" id="custom-tabs-two-home" role="tabpanel"
            ...
            <div class="form-group ">
                ...
                <textarea class="form-control" rows="5" name="description[ru]" type="textarea" id="textarea"
                    placeholder="{{App\Models\Translates::where('id',         $spainfo->description)->value('ru')}}">{{App\Models\Translates::where('id', $spainfo->description)->value('ru')}}</textarea>
        ...
        <div class="tab-pane fade" id="custom-tabs-kz" role="tabpanel" aria-labelledby="custom-tabs-two-kz">
            ...
            <div class="form-group ">
                ...
                <textarea class="form-control" rows="5" name="description[kz]" type="textarea" id="textarea">{{App\Models\Translates::where('id',$spainfo->description)->value('kz')}}
            </textarea>
        ...
        <div class="tab-pane fade" id="custom-tabs-two-profile" role="tabpanel"
            ...
            <div class="form-group ">
                ...
                <textarea class="form-control" rows="5" name="description[en]" type="textarea"
                    id="textarea">{{App\Models\Translates::where('id',         $spainfo->description)->value('en')}}</textarea>
