...
@section('content')
<a href="{{route('spa.menu.index')}}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left"
            aria-hidden="true"></i> Назад</button></a>
<form method="POST" action="{{ url('/admin/spamenu', $spamenu->id) }}" accept-charset="UTF-8"
